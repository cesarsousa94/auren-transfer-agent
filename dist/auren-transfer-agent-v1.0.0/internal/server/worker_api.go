...
func WorkerRoutes(options WorkerAPIOptions) []RouteDefinition {
	return []RouteDefinition{
		{Name: WorkerRouteName, Method: http.MethodGet, Pattern: WorkerPath, Handler: WorkerHandler(options)},
		{Name: WorkerJobsListRouteName, Method: http.MethodGet, Pattern: WorkerJobsPath, Handler: WorkerJobsHandler(options)},
		{Name: WorkerJobsCreateRouteName, Method: http.MethodPost, Pattern: WorkerJobsPath, Handler: CreateWorkerJobHandler(options)},
	}
}
