# Local Dev Console — v1.13.1

Auren Transfer Agent v1.13.1 adds a lightweight local console for development and first production validation. It intentionally does not replace Prometheus or Grafana. Its goal is to make the Agent understandable while integrating it with Auren Media Hub.
...
For package/bootstrap installs, the v1.13.1 bootstrap writes:
