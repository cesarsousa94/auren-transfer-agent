# Real Transfer Executor — v1.13.1

Auren Transfer Agent v1.2.0 added the real execution plane for Media Hub transfer jobs. v1.13.1 keeps that executor unchanged and adds the public Gateway Runtime as a separate HTTP path. Transfer jobs and streaming sessions remain independent execution lanes.
...
Not included in v1.13.1 transfer executor scope:
